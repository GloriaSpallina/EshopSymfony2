...
class FormulaireLoginAuthAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    use TargetPathTrait;
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $providerKey)
    {
        ...
        return new RedirectResponse($this->urlGenerator->generate('myaccount'));
